...
async function getCategory(catId) {
  let responses = await axios.get(`${BASE_API_URL}category`, {
    params: { id: catId },
  });
  let cat = responses.data;
...
async function fillTable() {
  ...
  $("#jeapordy thead").append($tr);
  // Add rows with questions for each category on the table //
